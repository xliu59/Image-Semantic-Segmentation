...
train_data_root_dir = '/media/jm/000B48300008D6EB/datasets/VOCdevkit/data'
trainset = VOC12(train_data_root_dir)
...
#     if i==50:
#         print(targets[0, 200:230, 200:230])
#         break
...
# output = fcn(input)
print(np.shape(trainset[50][0]))
# img = np.transpose(trainset[50],())
img = np.asarray(trainset[50][0], dtype=np.uint8)
plt.imshow(img)
plt.show()
